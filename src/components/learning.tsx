...
const LearningBegins = () => {
  return (
    <section className="px-20 py-10 flex items-center gap-4 h-screen">
      <div className="w-4/12 mx-auto space-y-4">
      ...
      <div className="w-8/12">
        <section className="flex items-center justify-between gap-4 mx-auto">
          <div className="w-1/2">
            <img className="h-[80vh] object-cover rounded-xl" src="/learn.jpg" alt="" />
          </div>
          <div className="w-1/2 space-y-4">
            <img className="h-[39vh] w-full rounded-xl" src="/hero.jpg" alt="" />
